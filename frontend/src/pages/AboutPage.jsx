  ...
  return (
    <div className="min-h-screen bg-[#faf7f0] flex flex-col justify-between">
      <div>
        ...
        {/* 1. Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-b from-[#faf7f0] to-[#f0ead9]/30 border-b border-[#e5ddc8]/40 pt-28 pb-20 text-center">
          ...
          <WideContainer>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <motion.div
                ...
                className="bg-white/90 rounded-3xl p-6 md:p-8 shadow-md border flex flex-col justify-between hover:shadow-xl transition-all duration-300 group"
              >
            ...
            <section className="space-y-10">
              <div className="text-center space-y-2">
                <h2 className="text-4xl font-bold text-[#2f5233] tracking-tight">Why HeritageAI Matters</h2>
                <p className="text-base text-gray-600 font-light">Key capabilities driving our cultural archiving pipeline</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
                {features.map((feature, idx) => (
                  <motion.div
                    ...
                    className="bg-white/90 border rounded-2xl p-6 shadow-md hover:shadow-xl hover:scale-[1.01] transition-all duration-300 flex flex-col justify-between min-h-[220px]"
                  >
                    <div className="space-y-4">
            ...
            <section className="py-12 flex flex-col items-center justify-center">
              <div className="text-center space-y-2 mb-10">
                <h2 className="text-4xl font-bold text-[#2f5233] tracking-tight">Meet the Developer</h2>
                <p className="text-base text-gray-600 font-light font-mono uppercase tracking-widest">Project Architect</p>
              </div>
