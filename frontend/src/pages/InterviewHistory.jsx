...
import { getAllInterviews, deleteInterview } from "../services/api"
...
function InterviewHistory() {
  ...
  const loadInterviews = async () => {
    ...
    try {
      ...
      setError("Could not load interviews. Please check the backend is running.")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-[#faf7f0]">
      ...
      <section className="px-6 pt-16 pb-10 text-center">
        ...
        >
          All the elder interviews you've saved so far.
        </motion.p>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {!isLoading && !error && interviews.length === 0 && (
            <p className="text-center text-gray-500">
              No interviews saved yet. Go record one!
            </p>
          )}
      ...
      {selectedInterview && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center px-6 z-50">
          ...
          >
            ...
            <div className="mt-6">
              <h3 className="text-lg font-semibold text-[#2f5233] mb-2">
                Transcript
              </h3>
